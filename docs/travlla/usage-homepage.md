...
::: tip
Travlla ships with **5 ready-made homepage layouts**. If you are using the sample data of **Travlla**, the
homepages are already created and set up for you — just pick the one you like and set it as the homepage.
:::
