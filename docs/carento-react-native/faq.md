...
Whatever you configure on your Botble backend. A created booking is returned as PENDING and checkout runs in a WebView against the backend's hosted payment page, so any gateway that works on the website also works in the app.
