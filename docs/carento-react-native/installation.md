...
Download the Carento source from CodeCanyon and extract it, then open a terminal in the project folder:
...
```bash
API_BASE_URL=http://carento.test        # your Botble backend, no trailing /api/v1
