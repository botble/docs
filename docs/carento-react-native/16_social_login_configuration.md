...
This document explains how the Carento car-rental app decides which social login providers appear on the login screen, and which environment keys each one needs.
