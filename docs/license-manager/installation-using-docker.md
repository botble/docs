...
License Manager utilizes [Laravel Sail](https://laravel.com/docs/13.x/sail). Please refer to the official documentation for instructions on how to use Laravel Sail.
