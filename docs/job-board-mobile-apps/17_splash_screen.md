...
Botble JobBoard keeps the branded splash on screen a little longer than the OS would, so the first frame users see is your styled home screen. There's never a white flash of unstyled content while fonts and cached settings load.
