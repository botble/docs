...
Botble JobBoard is an Expo SDK 54 / React Native 0.81 app using **expo-router** for file-based navigation, **React Context** for app state, and **@tanstack/react-query** over a custom `fetch` wrapper for the API. TypeScript strict mode throughout.
...
src/
  ...
  context/                    React Context providers (auth, settings, saved-jobs, compare, notification, toast, app-status)
