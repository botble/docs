...
Licenza includes a web-based installer for easy setup.

## Step 1: Upload Files

1. Download the package from [CodeCanyon](https://codecanyon.net/user/botble/portfolio)
...
After installation, configure Licenza:

### General Settings

Navigate to **Licenza → Settings → General**:
...
Navigate to **Licenza → Settings → API**:
...
Navigate to **Licenza → Settings → API Keys**:
