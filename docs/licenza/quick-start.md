...
Integrate license validation into your software in 5 minutes. Licenza uses a REST API, so it works with **any programming language** that can make HTTP requests.
...
From your Licenza admin panel:

| Credential | Where to Find |
|------------|---------------|
| **API URL** | Your Licenza URL (e.g., `https://license.yoursite.com`) |
