...
Customers are the end users who purchase and use your licensed software. The Licenza provides both admin management and a self-service customer portal.
...
1. Navigate to **Licenza → Customers**
2. Click **Create**
3. Fill in details:
   - Name
