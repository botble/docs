...
This guide will walk you through the process of upgrading Licenza. There are two ways to upgrade:
...
1. Download the latest version of the product from [CodeCanyon](https://codecanyon.net/user/botble/portfolio).
