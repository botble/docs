      ...
      { text: 'Table Builder', link: '/cms/table-builder' },
      {
        ...
        items: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'Autocomplete Field', link: '/cms/form-builder-auto-complete-field' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Theme Features', collapsed: true, items: [
            ...
            { text: 'Typography', link: '/cms/theme-development/theme-typography' },
            { text: 'Theme Helpers', link: '/cms/theme-development/theme-helpers' },
          ...
          { text: 'Advanced Theme Development', collapsed: true, items: [
            ...
            { text: 'Admin Bar', link: '/cms/theme-development/theme-admin-bar' },
            { text: 'Frontend Forms', link: '/cms/theme-development/theme-frontend-forms' },
