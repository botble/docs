...
|----------|-------------|
| **Main Navigation** | Primary header menu shown on all pages |
| **Footer Menu** | Links displayed in the footer area |
...
The main navigation automatically collapses into a hamburger menu on mobile devices. No additional configuration is required — the mobile menu is rendered from the same **Main Navigation** menu location.
