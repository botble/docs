    ...
    items: [
      {
        text: 'Installation',
        items: [
          { text: 'Requirements', link: '/jobzilla/installation-requirements' },
          { text: 'Using web interface', link: '/jobzilla/installation-web-interface' },
          { text: 'Using command line', link: '/jobzilla/installation-command-line' },
          { text: 'Using Docker', link: '/jobzilla/installation-using-docker' },
        ],
      },
