...
**Important:** Always create a backup of your website before upgrading. Contact your hosting provider if you need help with backups.
...
- Create or edit a test form
- Check that form submissions are working
- Verify your existing forms display correctly
- Test email notifications if you use them
