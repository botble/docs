...
::: warning
This feature requires a properly configured cronjob to work. Ensure your cronjob is set up before enabling. See [Setup Cronjob](https://docs.botble.com/amerce/cronjob.html) for instructions.
:::
