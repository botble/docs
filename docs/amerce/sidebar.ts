...
export default [
    ...
    },
    {
        ...
        items: [
            ...
            {
                text: 'UI Block & Shortcodes',
                items: [
                    { text: 'Overview', link: '/amerce/usage-ui-block' },
                    { text: 'Hero & Banners', link: '/amerce/shortcodes-hero-banners' },
                    { text: 'Products', link: '/amerce/shortcodes-products' },
                    { text: 'Categories, Brands & Vendors', link: '/amerce/shortcodes-categories-brands' },
                    { text: 'Lookbook & Visual', link: '/amerce/shortcodes-lookbook-visual' },
                    { text: 'Content', link: '/amerce/shortcodes-content' },
                    { text: 'Marketing & Trust', link: '/amerce/shortcodes-marketing' },
                    { text: 'Simple Slider override', link: '/amerce/shortcodes-simple-slider' },
                ],
            },
