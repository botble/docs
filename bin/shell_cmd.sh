...
projects=("cms" "flex-home" "lara-mag" "miranda" "stories" "jobcy" "farmart" "jobzilla" "transp" "gerow" "hasa" "shopwise" "martfury" "wowy" "nest" "ninico" "shofy" "athena" "cloudify" "homzen")
